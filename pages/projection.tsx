    ...
    return (
        <div style={{
            ...
            >
                ...
                {activatingDesktop && (
                    <div className="absolute top-5 right-5 bg-blue-600 text-white px-4 py-2 rounded-lg shadow-lg z-50 animate-pulse font-bold text-sm">
                        ASSUMINDO CONTROLE...
                    </div>
                )}
                {/* DRAW OVERLAY — recebe desenhos do /draw via BroadcastChannel + polling */}
                <DrawCanvas mode="viewer" />
